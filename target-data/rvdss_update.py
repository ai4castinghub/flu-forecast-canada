...
directory = './target-data/rvdss/season_2024_2025/'

# Check if the directory exists, and if not, create it
if not os.path.exists(directory):
    os.makedirs(directory)

path1 = './target-data/rvdss/season_2024_2025/respiratory_detections.csv'
path2 = './target-data/rvdss/season_2024_2025/positive_tests.csv'
